...
Widget _doubleItem(BuildContext context,CommonModel leftCart,CommonModel rightCart, bool big, bool last){

    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceAround,
      children: <Widget>[
        _item(context, leftCart,big,true,last),
        _item(context, rightCart,big,false,last),
